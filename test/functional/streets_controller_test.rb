...
class StreetsControllerTest < ActionController::TestCase
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post :create, street: { description: @street.description, endLocation: @street.endLocation, name: @street.name, startLocation: @street.startLocation, wikipediaLink: @street.wikipediaLink }
    end
  ...
  test "should update street" do
    put :update, id: @street, street: { description: @street.description, endLocation: @street.endLocation, name: @street.name, startLocation: @street.startLocation, wikipediaLink: @street.wikipediaLink }
    assert_redirected_to street_path(assigns(:street))
  end
